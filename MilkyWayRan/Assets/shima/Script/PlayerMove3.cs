...
public class PlayerMove3 : MonoBehaviour
{
    ...
    public AudioClip Player3_SE1;
    public AudioClip Player3_SE2;
    public AudioClip Player3_SE3;
    public AudioClip Player3_SE4;
    ...
    void OnCollisionEnter(Collision col)
    {
        ...
        {
            //小さい爆発の生成
            audioSource.PlayOneShot(Player3_SE2);
        ...
        {
            //小さい爆発の生成
            audioSource.PlayOneShot(Player3_SE3);
            var t = Instantiate(efect2, col.transform.position, Quaternion.identity);
            Debug.Log(PlayerNum + "がダメージをうけた");
            animator.SetBool("is_damage", true);
            Invoke("AnimatorBoolis_damage", 0.5f);
